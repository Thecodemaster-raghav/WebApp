...
server = StreamingServer(local_ip_add, 9999)
receiver = AudioReceiver(local_ip_add, 8888)
...
window = tk.Tk()
window.title("Calls v0.0.1 Alpha")
...
btn_listen = tk.Button(window, text="Start Listing", width=50, command=start_listening)
